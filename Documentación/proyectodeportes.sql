...
CREATE TABLE IF NOT EXISTS `proyecto`.`Temporada_equipo` (
  `idtemporada_tempeq` INT NOT NULL,
  `idequipo_tempeq` INT NOT NULL,
  `Presidente_temeq` VARCHAR(45) NULL,
  `idestadio_temeq` INT NOT NULL,
  `identrenador_temeq` INT NOT NULL,
  `division_temeq` INT NOT NULL,
  PRIMARY KEY (`idtemporada_tempeq`, `idequipo_tempeq`),
  INDEX `fk_Temporada_has_Equipo_Equipo1_idx` (`idequipo_tempeq` ASC),
  INDEX `fk_Temporada_has_Equipo_Temporada1_idx` (`idtemporada_tempeq` ASC),
  ...
  CONSTRAINT `fk_Temporada_has_Equipo_Temporada1`
    FOREIGN KEY (`idtemporada_tempeq`)
    REFERENCES `proyecto`.`Temporada` (`idtemporada`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Temporada_has_Equipo_Equipo1`
    FOREIGN KEY (`idequipo_tempeq`)
    REFERENCES `proyecto`.`Equipo` (`idequipo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
